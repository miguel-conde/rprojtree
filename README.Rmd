...
Currently there is only one template ("bais_template"). These templates have .json 
...
To finally create the project structure you can choose one of the built in templates:
